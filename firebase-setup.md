# Setting Up Firebase Sync for Hyamu
...
2.  Click **Add project** and give it a name (e.g., "Hyamu Sync").
...
3.  Register the app (e.g., "Hyamu App").
...
1.  Open the Hyamu app and go to **Settings**.
